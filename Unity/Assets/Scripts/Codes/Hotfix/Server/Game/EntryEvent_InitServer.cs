...
namespace ET.Server
{
    ...
    public class EntryEvent_InitServer: AEvent<ET.EventType.EntryEvent_InitServer>
    {
        protected override async ETTask Run(Scene scene, ET.EventType.EntryEvent_InitServer args)
        {
            // 发送普通actor消息
